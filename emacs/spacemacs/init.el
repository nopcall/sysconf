...
This function should only modify configuration layer settings."
  (setq-default
   ...
   '(
     ...
     javascript html
     ;; scripts
     lua windows-scripts shell-scripts cmake
     ;; writing
     latex markdown
     ;; configuration
     yaml json vimscript autohotkey)
...
It should only modify the values of Spacemacs settings."
  ...
  (setq-default
   ...
   ;; (default nil)
   dotspacemacs-initial-scratch-message ";; SHOW ME YOUR TRICK!\n"
...
before packages are loaded."
  ...
  (with-eval-after-load 'doom-modeline
    (doom-modeline-def-modeline
     ...
     '(workspace-name window-number modals persp-name buffer-info remote-host
                      vcs)
     '(repl debug lsp process matches checker buffer-position word-count parrot
  ...
  (with-eval-after-load 'org
    ...
    (setq org-capture-templates
          '(("c"  "Clipboard" entry
             (file+headline (lambda ()
                              (expand-file-name "Clipboard.org" org-directory))
                            "Clipboard")
             "* %^{Title} %U \n %i")
    ...
    (with-eval-after-load 'org-agenda
      ...
      (mapcar #'(lambda (file)
                  (when (file-exists-p file) (push file org-agenda-files)))
