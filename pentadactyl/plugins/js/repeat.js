...
// @Last Change: Sun 16 Feb 2014 10:58:04 PM CST
// @Revision: 423
// @Description:
// @Usage:
// @TODO:
...
let panel = repeat.store.get(aTab.linkedPanel);
if (panel) {
                        let img = ["img", {style: "vertical-align:middle;margin-right:5px;width:16px;height:16px;", src: aTab.image || DEFAULT_FAVICON}];
                        l.push(
                            ["tr", {style: "text-align:center;"},
                                [
                                    ["td", {}, window.gBrowser.tabContainer.getIndexOfItem(aTab)+1],
                                    ["td", {style: "vertical-align:middle;"}, [img, aTab.label]],
                                    ["td", {}, repeat.humanTime(panel[1])],
                                ]
                            ]
                        );
}
});
            let _dom = ["table", {styel: "border-spacing:8px 4px;border-collape: separate;"},
                [
                    ["thead", {},
                        ["tr", {},
                            [["th", {}, "Tab ID"], ["th", {}, "标题"], ["th", {}, "时间间隔"]]
                        ]
                    ],
                    ["tbody", {}, l]
                ]
