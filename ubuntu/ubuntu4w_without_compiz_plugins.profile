...
s0_alt_tab_next_window = <Shift><Control><Alt><Super>7
s0_alt_tab_prev_window = <Shift><Control><Alt><Super>8
s0_show_minimized_windows = true
s0_alt_tab_timeout = true
s0_alt_tab_bias_viewport = true
s0_disable_show_desktop = true
s0_disable_mouse = true
...
s0_mode_modes = 3;0;
s0_viewport_matches = class=Gnome-terminal;class=Firefox;
s0_viewport_x_values = 1;4;
...
[core]
s0_active_plugins = core;composite;opengl;regex;place;imgpng;session;wall;commands;compiztoolbox;copytex;mousepoll;snap;vpswitch;resize;grid;move;animation;unitymtgrabhandles;expo;workarounds;fade;scale;unityshell;
